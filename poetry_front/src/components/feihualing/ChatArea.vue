...
export default {
  ...
  methods: {
    ...
    loadHints() {
      const allHints = {
        '月': ['明月几时有', '海上生明月', '月下独酌无相亲', '举杯邀明月'],
        '花': ['花间一壶酒', '化作春泥更护花', '花开堪折直须折', '桃花潭水深千尺'],
        '春': ['春眠不觉晓', '春风又绿江南岸', '一年之计在于春', '春花秋月何时了'],
        '酒': ['劝君更尽一杯酒', '酒逢知己千杯少', '金樽清酒斗十千'],
        '山': ['山重水复疑无路', '青山不老', '山外青山楼外楼', '会当凌绝顶'],
        '鸟': ['鸟宿池边树', '千山鸟飞绝', '月出惊山鸟'],
        '水': ['恰似一江春水向东流', '黄河之水天上来', '落花流水春去也', '桃花潭水深千尺'],
        '云': ['白云深处有人家', '云想衣裳花想容', '坐看云起时', '黄河远上白云间'],
        '风': ['夜来风雨声', '风乍起', '大风起兮云飞扬', '春风不度玉门关'],
        '雪': ['雪花纷纷何所似', '万里雪飘']
      }
